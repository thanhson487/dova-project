        ...
        <div class="container ">
            <div class="row row-center-footer ">
                <div class="col-xs-12 col-sm-12 col-md-4 column-left col-center ">
                    ...
                    <div class="text1-footer ">Với đội ngũ chuyên gia có trình độ và kinh nghiệm chuyên môn giỏi, chúng tôi cam kết với khách hàng sản phẩm đều được kiểm tra kĩ lưỡng trước khi mang đến cho quý khách hàng để sản phẩm có chất lượng tốt nhất, đáng tin cậy nhất.
                    </div>
                </div>
                    ...
                    <div class="form-advisory wow fadeInUp animated " style="visibility: visible; animation-name: fadeInUp; ">
                        <form method="POST" action="contact.php" enctype="multipart/form-data">
                            ...
                            <div class="form-item wow fadeInUp " style="visibility: visible; animation-name: fadeInUp; ">
                                <p class="form-name form-add ">Họ và tên: <span>*</span></p>
                                <input type="text" name="name" value="" class="form-control ">
                                <?php 
                                if(isset($error) && in_array('name',$error))
                                {
                                    echo "<p style='color: red; font-size: 12px;'>Bạn hãy nhập họ và tên </p>";
                                }
                                ?>
                            ...
                            <div class="row ">
                                <div class="col-xs-12 col-sm-7 ">
                                    <div class="form-item wow fadeInUp " style="visibility: visible; animation-name: fadeInUp; ">
                                        ...
                                        <?php 
                                            ...
                                            {
                                                echo "<p style='color: red; font-size: 12px;'>Bạn hãy nhập email</p>";
                                            }
                                        ?>
                                        <div class="text-danger is-invalid "></div>
                                    </div>
                                ...
                                <div class="col-xs-12 col-sm-5 ">
                                    <div class="form-item wow fadeInUp " style="visibility: visible; animation-name: fadeInUp; ">
                                        <p class="form-add ">Số điện thoại: <span>*</span></p>
                                        <input type="text" name="phone" value="" class="form-control ">
                                        <?php 
                                            if(isset($error) && in_array('phone',$error))
                                            {
                                                echo "<p style='color: red; font-size: 12px;'>Bạn hãy nhập số điện thoại </p>";
                                            }
                                        ?>
                            ...
                            <div class="form-item wow fadeInUp " style="visibility: visible; animation-name: fadeInUp; ">
                                <p class="form-add ">Bạn muốn tư vấn? <span>*</span></p>
                                <textarea name="enquiry" rows="3 " value="" class="form-control "></textarea>
                                <?php 
                                    if(isset($error) && in_array('enquiry',$error))
                                    {
                                        echo "<p style='color: red; font-size: 12px;'>Bạn hãy nhập nội dung tư vấn</p>";
                                    }
                                ?>
                                <div class="text-danger is-invalid "></div>
                            </div>
                            <div>
                                <button class="btn btn-primary center-block button-submit wow fadeInUp form-add " style="visibility: visible; animation-name: fadeInUp; " type="submit" name="contact">Gửi yêu cầu tư vấn?</button>
                                <div>
                                    <?php
                                        if (! empty($message)) {
                                            ?>
                                        <p style='color: #15BDEF; font-size: 12px; display: flex; justify-content: center; display: flex; justify-content: center;'>
                                            <?php echo $message; ?>
                                        </p>
                                        <?php
                                        }
                ...
                <div class="col-xs-12 col-sm-1s2 col-md-4 column-rights ">
                    <div class="showroom ">
                        <div class="showroom-item wow fadeInUp animated " style="visibility: visible; animation-name: fadeInUp; ">
                            ...
                            <div class="address ">Số 25, 4/228 Thanh Bình, tổ dân phố 11, P. Mỗ Lao, Hà Đông, Hà Nội</div>
                        </div>
                        <div class="showroom-item wow fadeInUp animated " style="visibility: visible; animation-name: fadeInUp; ">
